...
@section('content')
	...
	<section class="slider-two">
		<div class="single-item-carousel owl-carousel owl-theme">
			...
			<div class="slide">
				...
				<div class="slider-two_pattern-layer" style="background-image:url(frontend/images/main-slider/pattern-1.png)"></div>
	...
	<section class="clients-one">
		<div class="clients-one_pattern" style="background-image:url(frontend/images/background/3.jpg)"></div>
		<div class="auto-container">
			<div class="row clearfix">
				<!-- Title Column -->
				...
				<div class="clients-one_carousel-column col-lg-8 col-md-12 col-sm-12">
					...
					<ul class="sponsors-carousel-two owl-carousel owl-theme">
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/5.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/6.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/7.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/8.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/5.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/6.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/7.png" alt=""></a></figure></li>
						<li class="slide-item"><figure class="client-one_image-box"><a href="#"><img src="frontend/images/clients/8.png" alt=""></a></figure></li>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="about-two_image-column col-lg-6 col-md-12 col-sm-12">
					<div class="about-two_pattern-one" style="background-image:url(frontend/images/background/pattern-12.png)"></div>
						...
						<div class="about-two_feature">
							<div class="row clearfix">
								...
								<div class="about-two_block col-lg-6 col-md-6 col-sm-6">
									<div class="about-two_block-inner">
										<span class="about-two_block-icon">
											<img src="frontend/images/icons/about-1.png" alt="" />
										</span>
								...
								<div class="about-two_block col-lg-6 col-md-6 col-sm-6">
									<div class="about-two_block-inner">
										<span class="about-two_block-icon">
											<img src="frontend/images/icons/about-2.png" alt="" />
										</span>
	...
	<section class="services-one">
		<div class="services-one_pattern-layer" style="background-image:url(frontend/images/background/pattern-14.png)"></div>
		<div class="auto-container">
				...
				<div class="four-item-carousel owl-carousel owl-theme">
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							<span class="service-block_three-icon"><img src="frontend/images/icons/service-8.png" alt="" /></span>
							...
							<div class="service-block_three-overlay">
								...
								<span class="service-block_three-icon-two"><img src="frontend/images/icons/service-8-1.png" alt="" /></span>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							<span class="service-block_three-icon"><img src="frontend/images/icons/service-9.png" alt="" /></span>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							<span class="service-block_three-icon"><img src="frontend/images/icons/service-10.png" alt="" /></span>
							<h5 class="service-block_three-heading">Project Management</h5>
							<div class="service-block_three-text">Our customers get solutions and business opportunities instead of just projects.</div>
							<div class="service-block_three-overlay">
								<div class="service-block_three-color-layer"></div>
								<span class="service-block_three-icon-two"><img src="frontend/images/icons/service-10-1.png" alt="" /></span>
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<div class="service-block_three-overlay">
								<div class="service-block_three-color-layer"></div>
								<span class="service-block_three-icon-two"><img src="frontend/images/icons/service-11-1.png" alt="" /></span>
	...
	<section class="case-one">
		<div class="case-one_pattern-layer" style="background-image:url(frontend/images/background/pattern-16.png)"></div>
		<div class="case-one_pattern-layer-two" data-parallax='{"y" : -100}' style="background-image:url(frontend/images/background/pattern-17.png)"></div>
		<div class="auto-container">
							...
							<div class="case-block_image">
								...
								<div class="case-one_overlay">
									<div class="case-one_overlay-content">
										<a href="frontend/images/resource/case-1.jpg" class="case-block_plus lightbox-image plus fa fa-plus"></a>
									</div>
								</div>
							</div>
					...
					<div class="case-block">
						<div class="case-block_inner">
							<div class="case-block_image">
								...
								<div class="case-one_overlay">
									<div class="case-one_overlay-content">
										<a href="frontend/images/resource/case-2.jpg" class="case-block_plus lightbox-image plus fa fa-plus"></a>
									</div>
								</div>
							</div>
							<div class="case-block_lower-content">
					...
					<div class="case-block">
						<div class="case-block_inner">
							<div class="case-block_image">
								...
								<div class="case-one_overlay">
									<div class="case-one_overlay-content">
										<a href="frontend/images/resource/case-3.jpg" class="case-block_plus lightbox-image plus fa fa-plus"></a>
									</div>
								</div>
							</div>
							<div class="case-block_lower-content">
	...
	<section class="choose-one">
		<div class="choose-one_pattern-layer" style="background-image:url(frontend/images/background/pattern-19.png)"></div>
		<div class="auto-container">
							...
							<div class="row clearfix">
								...
								<div class="choose-one_image-column col-lg-6 col-md-12 col-sm-12">
									<div class="choose-one_image-inner">
										<div class="choose-one_dotted-layer" style="background-image:url(frontend/images/background/pattern-18.png)"></div>
										<div class="choose-one_color-layer"></div>
										<div class="choose-one_image">
											<img src="frontend/images/resource/choose.jpg" alt="" />
										</div>
									</div>
								</div>
								<!-- Content Column -->
	...
	<section class="counter-two">
		<div class="auto-container">
			<div class="counter-two_inner-container">
				<div class="counter-two_pattern-one" style="background-image:url(frontend/images/background/pattern-20.png)"></div>
				<div class="counter-two_pattern-two" style="background-image:url(frontend/images/background/pattern-21.png)"></div>
				<div class="counter-two_pattern-three" style="background-image:url(frontend/images/background/pattern-22.png)"></div>
				<div class="counter-two_image-layer" style="background-image:url(frontend/images/background/4.jpg)"></div>
	...
	<section class="pricing-one">
		<div class="pricing-one_pattern-layer" style="background-image:url(frontend/images/background/pattern-23.png)"></div>
		<div class="pricing-one_pattern-two" data-parallax='{"y" : -80}' style="background-image:url(frontend/images/background/pattern-24.png)"></div>
		<div class="auto-container">
	...
	<section class="testimonial-section" style="background-image: url(frontend/images/background/5.jpg)">
		<div class="pattern-layer-one" style="background-image: url(frontend/images/background/pattern-25.png)"></div>
		<div class="auto-container">
			<div class="row clearfix">
...
network Access provides is valuable.</div>
				...
				<div class="carousel-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column" style="background-image: url(frontend/images/background/pattern-26.png)">
						<div class="authors-outer">
							<div class="author-one">
								<img src="frontend/images/resource/author-2.jpg" alt="" />
							</div>
							<div class="author-two">
								<img src="frontend/images/resource/author-3.jpg" alt="" />
							</div>
							<div class="author-three">
								<img src="frontend/images/resource/author-4.jpg" alt="" />
							</div>
							<div class="author-four">
								<img src="frontend/images/resource/author-5.jpg" alt="" />
							</div>
						</div>
						<div class="single-item-carousel owl-carousel owl-theme">
		...
		<div class="auto-container">
			...
			<div class="news-carousel owl-carousel owl-theme">
				...
				<div class="news-block">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="frontend/images/resource/news-4.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							...
							<div class="lower-box">
								<div class="d-flex justify-content-between align-items-center flex-wrap">
									<div class="author">
										<span class="author-image"><img src="frontend/images/icons/news-icon.png" alt="" /></span>
										Rayan Colins
									</div>
				...
				<div class="news-block">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="frontend/images/resource/news-5.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="post-date">June 10, 2021</div>
				...
				<div class="news-block">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="frontend/images/resource/news-6.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<div class="post-date">June 10, 2021</div>
