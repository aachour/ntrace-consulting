							...
							<form method="post" action="{{ route('submitForm') }}" id="contact-form" enctype="multipart/form-data">
								...
								<div class="row clearfix">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 form-group">
										...
										<input  wire:model.defer="name"  type="text"  id="name" name="name" placeholder="Your Name..." autocomplete="on">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 form-group">
										...
										<input wire:model.defer="email" type="email" id="email" name="email" placeholder="Your E-mail...">
									...
									<div class="col-lg-6 col-md-12 col-sm-12 form-group">
										...
										<input wire:model.defer="phone" type="text" id="phone" name="phone" placeholder="Your Phone Number...">
									...
									<div class="col-lg-6 col-md-12 col-sm-12 form-group">
										<label>Subject</label>
										<input wire:model.defer="subject" type="text"  id="subject" name="subject" placeholder="Subject..." autocomplete="on">
									</div>
									
									<div class="col-lg-12 col-md-12 col-sm-12 form-group">
										<label>Your message <span>*</span></label>
										<textarea  wire:model.defer="message" id="message" name="full_name" placeholder="Your message" rows="5"></textarea>
