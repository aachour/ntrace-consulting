				...
				<div class="about-two_content col-lg-6 col-md-12 col-sm-12">
					<div class="about-two_content-inner">
						...
						<div class="about-two_text">
							Ntrace Consulting was born from the idea of ​​creating a network of seasoned experts who have dedicated their careers to supporting companies in achieving their strategic objectives in terms of production and information technology (IT).
							Specializing in information technology services, Ntrace Consulting is part of a context where IT has become an essential element of each sector of activity, and where data management (DATA)
							is an essential lever for performance and innovation.
							In order to strengthen and optimize data-centric approaches, our team of expert consultants, working in various areas of IT, is mobilized to support companies in improving their services,
							infrastructures and applications. We are committed to helping you achieve your technological and strategic objectives with efficiency and excellence.						</div>
				...
				<div class="four-item-carousel owl-carousel owl-theme">
					...
					<div class="service-block_three">
						<div class="service-block_three-inner">
							...
							<h5 class="service-block_three-heading">Artificial Intelligence</h5>
							<div class="service-block_three-text">Our customers get solutions and business opportunities instead of just projects.</div>
							<div class="service-block_three-overlay">
								<div class="service-block_three-color-layer"></div>
